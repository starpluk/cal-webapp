      ...
      await liff.sendMessages([
        {
          ...
          "\nเบอร์โทร : "+telLIFF+
          "\nE-mail : "+emailLIFF+"\n\nเงื่อนไข :\n📌 ราคานี้ไม่รวม\n- Vat 7%\n- ค่าประกันสินค้า 2% ของมูลค่าสินค้า+ค่าขนส่ง\n- ไม่รวมค่ารับสินค้า (กทม.)\n- ไม่รวมพื้นที่ห่างไกลปลายทาง (ถ้ามี)\n- ไม่รวมภาษีนำเข้าที่ประเทศปลายทางขึ้นอยู่กับกรมศุลกากร และค่าใช้จ่ายอื่นๆ ตามใบเสร็จจริงที่ปลายทาง (ถ้ามี)\n- กรณีโดนเปิดตรวจ สินค้าอาจจะโดนตีกลับหรือถูกทำลาย ขึ้นอยู่กับการพิจารณาของกรมศุลกากรปลายทาง (ถ้ามี)\n\n\"📌📦 ในการคิดค่าใช้จ่ายสินค้าทางเราจะเปรียบเทียบระหว่างน้ำหนักไดเมนชั่นก็คือ ขนาดกล่องสินค้าที่แพ็คแล้ว หรือขนาดสินค้าที่ยังไม่ได้แพ็ค จะคิดจาก กxยxส (cm.) หาร 5,000 \nจะได้เป็นน้ำหนักไดเมนชั่น แล้วมาเปรียบเทียบกับน้ำหนักสินค้าจริง น้ำหนักไหนมากกว่า ทางเราจะใช้น้ำหนักนั้นในการคิดค่าใช้จ่าย แต่ละครั้งค่ะ\"\n"
        },
      ]);
      closed();
    }
